...
private:
	...
	void CalculateMeanCovariance(const Eigen::MatrixXf& samples, size_t num_samples, const VectorReal& weights, VectorReal& mean, MatrixReal& covariance);
	...
	void EM_maximization(const Eigen::MatrixXf& samples, size_t num_samples, const MatrixReal& sample_weights);
