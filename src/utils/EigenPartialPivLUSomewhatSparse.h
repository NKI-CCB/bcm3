...
public:
	...
	{
		using Eigen::PartialPivLU< MatrixType >::m_lu;
		using Eigen::PartialPivLU< MatrixType >::m_l1_norm;
		using Eigen::PartialPivLU< MatrixType >::m_rowsTranspositions;
