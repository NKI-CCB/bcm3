...
bool Cell::Initialize(Real creation_time, const VectorReal& transformed_variables, VectorReal* sobol_sequence_values, bool is_initial_cell, bool calculate_synchronization_point, Real fixed_abs_value, Real fixed_rel_value)
{
	cvode_steps = 0;
	cvode_timepoint_iter = 0;
	...
	CVodeSStolerances(cvode_mem, fixed_abs_value, fixed_rel_value);
