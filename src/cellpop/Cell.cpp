...
bool Cell::Initialize(Real creation_time, const VectorReal& transformed_variables, VectorReal* sobol_sequence_values, bool is_initial_cell, bool calculate_synchronization_point, std::vector<int> tolerance_vector)
{
	cvode_steps = 0;
	cvode_timepoint_iter = 0;
	...
	CVodeSStolerances(cvode_mem, tolerance_vector[0], tolerance_vector[1]);
